...
class RecipeImageUploadTests(TestCase):
    ...
    def test_upload_image_to_recipe_wrong_format(self):
        """Testing the upload of and invalid image"""
        url = image_upload_url(self.recipe.id)
    ...
    def test_filter_recipe_by_ingredients(self):
        ...
        query_string = {'ingredients': f'{ingredient1.id},{ingredient2.id}'}
        res = self.client.get(RECIPES_URL, query_string)
